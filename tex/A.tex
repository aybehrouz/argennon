...
\begin{document}
    ...
    \begin{abstract}
        ...
        a centralized and a decentralized system. Argennon validators do not store the blockchain state and
        transaction validation does not require costly
        computational resources. In Argennon, normal personal computers or smartphones, with limited hardware
