...
\begin{document}
    ...
    \begin{abstract}
        ...
        outsourced to the Argennon cloud and normal personal computers or smartphones, with limited hardware
        capabilities, can validate transactions and actively
        participate in the consensus protocol. This property makes Argennon a truly decentralized and
        ...
        This set up allows for very high transaction throughput while at the same time remaining highly secure. The network 
        stays safe as long as at least one delegate and at least 1/3 of the validators in all validator assemblies remain honest.
    \end{abstract}
    \tableofcontents
