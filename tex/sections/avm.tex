...
of execution time and a request for accessing some memory locations for reading or writing. If after starting,
...
account who has provided the required digital signature for fee payment.}
