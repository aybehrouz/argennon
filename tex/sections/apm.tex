...
\begin{itemize}
    ...
    normally. It outputs the updated heap chunks and an $accept_N$ flag. More formally it evaluates $(H',accept_N)=P(H,
    R_{good})$, where $H'$ is the updated heap chunks and the $accept_N$ flag will be set to false, If an
    ...
    those requests whose execution terminates abnormally, $H'$ is the output of the NEU and the $accept_F$ flag is set
