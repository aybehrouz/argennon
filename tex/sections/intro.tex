...
In addition to the ASAR, on the blockchain an Argennon application is stored in the Argennon Prover Machine (APM) code.
This code is used by validators for CI proof verification. The Argennon Prover Machine is a virtual
