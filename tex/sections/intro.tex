...
tries to corrupt participants of a protocol by offering them money to make them violate the protocol.
...
simple and similar computer systems. That means, they all have similar vulnerabilities and weaknesses which could be
used by an adversary to catastrophically attack the consensus protocol. For example, if a malware, probably using a
common zero-day
...
special High Priority Transaction (HPT) protocol.
