...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \(B_{u,t}\) is the balance of the user \(u\) at the time step \(t\).
        \item \(M_{u,t}\) is the EMA for the user \(u\) at the time step \(t\).
    \end{itemize}
    ...
    we can obtain \(m\) from the following formula, when \(\alpha\) is small:
    \[
